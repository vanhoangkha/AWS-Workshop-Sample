...
If your favicon is a png, just drop off your image in your local `static/images/` folder and name it `favicon.png?featherlight=false&width=90pc`
...
![Red variant](/en/basics/style-customization/images/red-variant.png?featherlight=false&width=90pc?width=60pc)
...
![Blue variant](/en/basics/style-customization/images/blue-variant.png?featherlight=false&width=90pc?width=60pc)
...
![Green variant](/en/basics/style-customization/images/green-variant.png?featherlight=false&width=90pc?width=60pc)
