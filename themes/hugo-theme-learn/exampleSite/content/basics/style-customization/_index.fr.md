...
Si votre favicon est un png, déposez votre image dans votre dossier local `static/images/` et nommez le `favicon.png?featherlight=false&width=90pc`
...
```html
<link rel="shortcut icon" href="/images/favicon.png?featherlight=false&width=90pc" type="image/x-icon" />
```
...
![Variante rouge](/en/basics/style-customization/images/red-variant.png?featherlight=false&width=90pc?width=60pc)
...
![Variante bleue](/en/basics/style-customization/images/blue-variant.png?featherlight=false&width=90pc?width=60pc)
...
![Variante verte](/en/basics/style-customization/images/green-variant.png?featherlight=false&width=90pc?width=60pc)
